...
public class testmb{
    ...
    public void spanishpage() throws InterruptedException {
        ...
        //wait for popups
        try {
            //wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//*[@id=\"pmConsentWall\"]/div/div/div[2]/div[1]/a"))));
            Thread.sleep(3000);
            //driver.switchTo().frame(driver.findElement(By.xpath("//*[@id=\"destination_publishing_iframe_prisacom_0\"]")));
            //String str= driver.findElement(By.xpath("//*[@id=\"pmConsentWall\"]/div/div/div[2]/div[1]/a")).getText();
            //System.out.println(str);
            //driver.findElement(By.xpath("//*[@id=\"pmConsentWall\"]/div/div/div[2]/div[1]/a"));
        ...
        driver.findElement(By.xpath("//button[@id=\"btn_open_hamburger\"]")).click();
        //add
        try {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id=\"s-btn-pbs\"]")));
            //closing add
            driver.findElement(By.xpath("//button[@id=\"s-btn-pbs\"]")).click();
            //wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/button[@id=\"btn_open_hamburger\"]")));
            Thread.sleep(1000);
            driver.findElement(By.xpath("//button[@id=\"btn_open_hamburger\"]")).click();
